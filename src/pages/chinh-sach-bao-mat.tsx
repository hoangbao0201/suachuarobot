...
const PolicyPage : NextPageWithLayout= () => {
    return (
        <>
            <Head title="Chính sách bảo mật - vesmart" description="Chính sách bảo mật ❶✔️ Web đọc truyện tranh online lớn nhất - Truyện tranh hay nhất, chất lượng được cập nhật liên tục mỗi ngày"/>
            <WrapLayout className="">
                ...
                <div className="">
                    ...
                    <p className="mb-2">Địa chỉ website là: <Link href={`/`} className="text-blue-700"><u>vesmart.vercel.online</u></Link>, website đăng tải những bài viết.</p>
